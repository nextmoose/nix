...
in {
	...
	github-create-public-key = structures.github-create-public-key ( literal-cat "personal-access-token.asc" ./private ) ( literal "report" ) ( structure-file "id-rsa.pub" report-id-rsa ) ;
