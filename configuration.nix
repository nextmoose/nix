...
#	    ( ( structures "/home/user/structures" ).single-site-dot-ssh ( literal "upstream" ) ( literal "github.com" ) ( literal "git" ) ( literal 22 ) ( structure-file ( ( structures "/home/user/structures" ).ssh-keygen ( structure-cat ( ( structures "/home/user/structures" ).personal-identification-number ( literal "pin.asc" ) ( literal 6 ) ( literal "67b4e892-ef69-4253-9e21-459a1c33645a" ) ) "pin.asc" ) ) "id-rsa.asc" ) ( structure-dir ( utils.system-secret ( literal "upstream.known_hosts" ) ( literal "known-hosts.asc" ) ) ) )
